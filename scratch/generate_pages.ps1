...
.hw-section .section-title { color: var(--navy); margin-bottom: 12px; }
.hw-section-sub { font-size: 16px; color: var(--muted); margin-bottom: 40px; }
.hw-grid {
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  gap: 24px;
...
.hw-card h4 { font-size: 22px; font-weight: 800; color: var(--navy); margin-bottom: 6px; letter-spacing: -.02em; }
.hw-role { font-size: 12px; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; color: var(--blue); margin-bottom: 12px; }
.hw-desc { font-size: 13px; color: var(--muted); line-height: 1.7; }
